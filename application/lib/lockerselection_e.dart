...
class LockerSelectionPageE extends StatefulWidget {
  @override
  _LockerSelectionPageEState createState() => _LockerSelectionPageEState();
}

class _LockerSelectionPageEState extends State<LockerSelectionPageE> {
  late List<int> lockerStatusList;
  String location = '공대 4호관';
